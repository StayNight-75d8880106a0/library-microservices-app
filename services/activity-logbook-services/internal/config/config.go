...
func NewPortConfig() *PortConfig {
	return &PortConfig{
		PORT: os.Getenv("LOGBOOK_SERVICE_PORT"),
	}
}
...
func NewPostgresConfig() *PostgresConfig {
	return &PostgresConfig{
		Host:     os.Getenv("logbookService_POSTGRES_HOST"),
		Port:     os.Getenv("DB_PORT_GLOBAL"),
		User:     os.Getenv("logbookService_POSTGRES_USER"),
		Passwrod: os.Getenv("logbookService_POSTGRES_PASSWORD"),
		Name:     os.Getenv("logbookService_POSTGRES_NAME"),
